...
hi exConfirmLine gui=none guibg=#679dff term=none cterm=none ctermbg=darkyellow

hi clear exTargetLine
hi exTargetLine gui=none guibg=#679dff term=none cterm=none ctermbg=darkyellow
